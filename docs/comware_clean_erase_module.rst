...
.. raw:: html
    ...
    <th class="head">comments</th>
        ...
        <td style="vertical-align:middle;text-align:left">Set to true if all logs and user-created files              should be deleted and removed from the system              and the device should be set to factory default              settings</td>
    </tr>
