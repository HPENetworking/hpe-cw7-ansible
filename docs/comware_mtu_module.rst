...
.. raw:: html
    ...
    <tr style="text-align:center">
        ...
        <td style="vertical-align:middle"></td>
        <td style="vertical-align:middle"></td>
        <td style="vertical-align:middle;text-align:left">Specify Maximum Transmission Unit(MTU) of the interface</td>
    </tr>
    <tr style="text-align:center">
        <td style="vertical-align:middle">jumboframe</td>
        <td style="vertical-align:middle">no</td>
        <td style="vertical-align:middle"></td>
        <td style="vertical-align:middle"></td>
        <td style="vertical-align:middle;text-align:left">Specify Maximum jumbo frame size allowed of the interface</td>
    </tr>
    <tr style="text-align:center">
...
.. note:: mtu can be set in interface type of ['GigabitEthernet','Ten-GigabitEthernet','FortyGigE','Vlan-interface','Route-Aggregation','TwentyGigE','Twenty-FiveGigE','HundredGigE'] andsome of these must be set as route mode.jumboframe can be set in interface type of ['GigabitEthernet','Ten-GigabitEthernet','FortyGigE','Bridge-Aggregation','Route-Aggregation','TwentyGigE','Twenty-FiveGigE','HundredGigE']